      ...
      >
        <div className="bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          >
            ...
            <label 
              htmlFor="email"
              className="block text-sm font-medium text-gray-300 pt-6"
            >
              Email address
            </label>
            ...
            <button
              ...
              className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md
                         shadow-sm text-sm font-medium text-white bg-blue-500 hover:bg-blue-700
                         focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition
                         duration-150 ease-in-out disabled:opacity-50 mt-10"
              disabled={loading}   
            >
              {
                loading ? (
          ...
          <p className="mt-8 text-center text-sm text-gray-400">
              ...
              >
                Sign up now <ArrowRight className="inline h-4 w-4 mb-0.5"/>
              </Link>
          </p>
